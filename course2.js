/*
* 当你不会补充window环境数据时可以用模拟器来执行js解决环境不足问题
* */
window = global;
var navigator = {}
...
function() {
    var t = "mozilla/5.0 (windows nt 10.0; win64; x64) applewebkit/537.36 (khtml, like gecko) chrome/83.0.4103.116 safari/537.36";
    if (true) {
